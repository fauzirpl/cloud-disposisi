                ...
                <form>
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input type="text" name="nomor_surat" value="{{$suratkeluar->nomor_surat}}" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-left col-md-3">Tanggal Surat</label>
                            <div class="col-md-9">
                                <input type="date" class="form-control" value="{{$suratkeluar->tanggal_surat}}" disabled name="tanggal_surat" placeholder="hh/bb/tttt">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-left col-md-3">Tujuan</label>
                            <div class="col-md-9">
                            <input type="text" name="tujuan" value="{{$suratkeluar->tujuan}}" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-left col-md-3">Isi Singkat/Perihal</label>
                            <div class="col-md-9">
                            <textarea name="isi_singkat" class="form-control" disabled>{{$suratkeluar->isi_singkat}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
